...
struct OptParseTestCase {
    ...
    _maybe_unused OptParseTestCase &str_case(const char *k, const char *v, const char *default_v = "") {
    ...
    _maybe_unused OptParseTestCase &int64_case(const char *k, int64_t v, int64_t default_v = 0) {
...
_maybe_unused const char *case1[] = {"--a=b"};
_maybe_unused const char *case2[] = {"--a="};
_maybe_unused const char *case3[] = {"--b=1"};
...
TEST_P(OptParseTest, WillNotThrowException) /* NOLINT */
{
    ...
    for (auto &str_case : param.str_cases) {
        const auto&[opt, storage, expected] = str_case;
    ...
    for (auto &int64_case : param.int64_cases) {
        const auto&[opt, storage, expected] = int64_case;
